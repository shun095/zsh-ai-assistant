...
# Test suite for comment extraction functionality
Describe 'zsh_ai_assistant_extract_comment()'
  # Test 1: Extract comment content
  It 'should extract comment content from line'
    When call zsh_ai_assistant_extract_comment "# list files in current directory"
    The output should eq "list files in current directory"
  End

  # Test 2: Extract comment content with leading whitespace
  It 'should extract comment content with leading whitespace'
    When call zsh_ai_assistant_extract_comment "  # list files"
    The output should eq "list files"
  End

  # Test 3: Extract comment content with trailing whitespace
  It 'should extract comment content with trailing whitespace'
    When call zsh_ai_assistant_extract_comment "# list files   "
    The output should eq "list files"
  End

  # Test 4: Handle empty comment
  It 'should return empty string for empty comment'
    When call zsh_ai_assistant_extract_comment "#"
    The output should eq ""
  End
End

# Test suite for animation frame counting
Describe 'zsh_ai_assistant_animation_frame_count'
  # Test 1: Frame count starts at 0
  It 'should start frame count at 0'
    # Reset frame count
    zsh_ai_assistant_animation_frame_count=0
    
    When call test_get_animation_frame_count
    The output should eq "0"
  End

  # Test 2: Frame count can be set and retrieved
  It 'should be able to set and retrieve frame count'
    zsh_ai_assistant_animation_frame_count=42
...
# Test suite for animation start time
Describe 'zsh_ai_assistant_animation_start_time'
  # Test 1: Start time can be set and retrieved
  It 'should be able to set and retrieve start time'
    zsh_ai_assistant_animation_start_time="1234567890"
    
    When call test_get_animation_start_time
    The output should eq "1234567890"
  End

  # Test 2: Start time starts empty

...
class TestAIConfig:
    ...
    def test_valid_configuration_with_all_required_fields(self, reset_env):
    ...
    def test_valid_configuration_with_custom_settings(self, reset_env):
    ...
    def test_invalid_configuration_without_api_key(self, reset_env):
    ...
    def test_invalid_configuration_without_base_url(self, reset_env):
    ...
    def test_invalid_configuration_without_both_api_key_and_base_url(self, reset_env):
        """Test invalid configuration without both API key and base URL."""
        config = AIConfig()
        
        assert config.is_valid is False

    def test_string_representation_of_configuration(self, reset_env):
    ...
    def test_default_base_url(self, reset_env):
    ...
    def test_default_model(self, reset_env):
    ...
    def test_default_temperature(self, reset_env):
    ...
    def test_default_max_tokens(self, reset_env):

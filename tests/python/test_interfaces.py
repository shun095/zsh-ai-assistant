...
class TestInterfaces:
    ...
    def test_aiserviceinterface_has_required_methods(self):
        """Test that AIServiceInterface has the required abstract methods."""
    ...
    def test_chathistoryinterface_has_required_methods(self):
        """Test that ChatHistoryInterface has the required abstract methods."""
    ...
    def test_inmemorychathistory_implements_chathistoryinterface(self):
        """Test that InMemoryChatHistory implements ChatHistoryInterface."""
    ...
    def test_langchainaiservice_implements_aiserviceinterface(self):
        """Test that LangChainAIService implements AIServiceInterface."""
    ...
    def test_concrete_classes_implement_all_interface_methods(self):
        """Test that concrete classes implement all interface methods."""
